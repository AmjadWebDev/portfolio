    ...
    <section id="projects">
      <div className="projects-container">
        ...
        <div className="projects-wrapper">
          <Project title="Contacto - contacts manager" img={'/projects/contacto.png'} tech="js css react node mongoDB" link="https://contacto-contacts-manager.herokuapp.com/login" repo="https://github.com/AmjadWebDev/contacts-saver">
          ...
          <Project title="Magic The Gathering" img={'/projects/mtg.png'} tech="js css react" link="https://mtg-p2.netlify.app/" repo="https://github.com/AmjadLille/lille-0920b-js-aquali-magic/tree/final">
          ...
          <Project title="ancient-egypt-hackaton" img={'/projects/egypt.png'} tech="js css react node " link="https://ancient-egypt-hackaton.netlify.app/" repo="https://github.com/AmjadLille/ancient-egypt-hackaton">
          ...
          <Project title="Covid-19 updates" img={'/projects/covid.png'} tech="js css react node mongoDB" link="https://amjadcovid19.netlify.app/" repo="https://github.com/AmjadLille/Covid-19">
          ...
          <Project title="Weather App " img={'/projects/weather.png'} tech="html css node mongoDB" link="https://amjad-weather-app-nodejs.herokuapp.com/" repo="https://github.com/AmjadWebDev/nodeJs-weather-app">
            <small>Built using Node, Express, CSS, Heroku.</small>
            <p>This is a web app to check the weather in any city in the world.</p>
          </Project>
          <Project title="Web App ( V'Lille )" img={'/projects/vlille.png'} tech="js css react node mongoDB" link="https://vlilleapp.netlify.app/" repo="https://github.com/AmjadLille/lille-0320-js-mystic-vlille">
            <small>Built using Node, Express, MongoDB, CSS, React.js and React Router.</small>
